...
window.addEventListener("beforeunload", function(e) {
    (e || window.event).returnValue = 'All unsaved changes will be lost.';
 ...
 * GTheme getRandomID
 * 
 * @use generates an unique ID based
 *      on given prefix
 * ============================================= */
function getRandomID(prefix) {
    ...
    if (jQuery('#' + prefix + randomstring).length > 0)
        randomstring = getRandomID();
 ...
 * @param - {string} value 
 * 
 * @use - parsing escaped JSON object
 * ============================================= */
var entityMap = {
    "&": "&amp;",
    "<": "&lt;",
 ...
 * @param - {string} value 
 * 
 * @use - parsing unescaped JSON object
 * ============================================= */
 ...
 * @param - {object} obj 
 * 
 * @use - copying an object by value
 * ============================================= */
...
/*!
 * jQuery contextMenu2 - Plugin for simple contextMenu2 handling
 *
 * Version: git-master
 *
 * Authors: Rodney Rehm, Addy Osmani (patches for FF)
 * Web: http://medialize.github.com/jQuery-contextMenu2/
 *
 * Licensed under
...
// determine html5 compatibility
    ...
    var // currently active contextMenu2 trigger
            $currentTrigger = null,
            // is contextMenu2 initialized with at least one menu?
            initialized = false,
            // window handle
            $win = $(window),
            ...
            // default values
            defaults = {
                // selector of contextMenu2 trigger
                selector: null,
                ...
                determinePosition: function($menu) {
                    ...
                    if ($.ui && $.ui.position) {
                        ...
                        // determine contextMenu2 position
    ...
    zindex = function($t) {
        ...
        return zin;
            ...
            handle = {
                    ...
                    if (!$this.hasClass('context-menu-disabled')) {
                        ...
                        if (e.data.build) {
                            ...
                            if (!e.data.items || $.isEmptyObject(e.data.items)) {
                                ...
                                if (window.console) {
                                    (console.error || console.log)("No items specified to show in contextMenu2");
                                }
                ...
                // contextMenu2 left-click trigger
                click: function(e) {
                    e.preventDefault();
                    e.stopImmediatePropagation();
                    $(this).trigger($.Event("contextmenu", {data: e.data, pageX: e.pageX, pageY: e.pageY}));
                },
                // contextMenu2 right-click trigger
                mousedown: function(e) {
                    // register mouse down
                    var $this = $(this);
                    ...
                    if ($currentTrigger && $currentTrigger.length && !$currentTrigger.is($this)) {
                        $currentTrigger.data('contextMenu2').$menu.trigger('contextmenu:hide');
                    }

                    // activate on right click
                    if (e.button == 2) {
                        $currentTrigger = $this.data('contextMenu2Active', true);
                    }
                },
                // contextMenu2 right-click trigger
                mouseup: function(e) {
                    // show menu
                    var $this = $(this);
                    if ($this.data('contextMenu2Active') && $currentTrigger && $currentTrigger.length && $currentTrigger.is($this) && !$this.hasClass('context-menu-disabled')) {
                        e.preventDefault();
                        e.stopImmediatePropagation();
                        $currentTrigger = $this;
                        $this.trigger($.Event("contextmenu", {data: e.data, pageX: e.pageX, pageY: e.pageY}));
                    ...
                    $this.removeData('contextMenu2Active');
                },
                // contextMenu2 hover trigger
                mouseenter: function(e) {
                    ...
                    $document.on('mousemove.contextMenu2Show', handle.mousemove);
                    hoveract.timer = setTimeout(function() {
                        hoveract.timer = null;
                        $document.off('mousemove.contextMenu2Show');
                        $currentTrigger = $this;
                ...
                // click on layer to hide contextMenu2
                layerClick: function(e) {
                    var $this = $(this),
                            root = $this.data('contextMenu2Root'),
                            mouseup = false,
                            button = e.button,
                            x = e.pageX,
                            y = e.pageY,
                ...
                key: function(e) {
                    var opt = $currentTrigger.data('contextMenu2') || {};
                    ...
                    switch (e.keyCode) {
                        ...
                        case 39: // right
                            ...
                            var itemdata = opt.$selected.data('contextMenu2') || {};
                ...
                prevItem: function(e) {
                    e.stopPropagation();
                    var opt = $(this).data('contextMenu2') || {};

                    // obtain currently selected menu
                    if (opt.$selected) {
                        var $s = opt.$selected;
                        opt = opt.$selected.parent().data('contextMenu2') || {};
                        opt.$selected = $s;
                    }
                ...
                focusInput: function(e) {
                    var $this = $(this).closest('.context-menu-item'),
                            data = $this.data(),
                            opt = data.contextMenu2,
                            root = data.contextMenu2Root;
                ...
                menuMouseenter: function(e) {
                    var root = $(this).data().contextMenu2Root;
                    root.hovering = true;
                },
                // :hover on menu
                ...
                // contextMenu2 item click
                itemClick: function(e) {
                    var $this = $(this),
                            data = $this.data(),
                            opt = data.contextMenu2,
                            root = data.contextMenu2Root,
                            key = data.contextMenu2Key,
                            callback;
    ...
    op = {
        show: function(opt, x, y) {
            ...
            $trigger
                    .data('contextMenu2', opt)
                    .addClass("context-menu-active");

            // register key handler
            $(document).off('keydown.contextMenu2').on('keydown.contextMenu2', handle.key);
            // register autoHide handler
            if (opt.autoHide) {
                // mouse position handler
                $(document).on('mousemove.contextMenu2AutoHide', function(e) {
        ...
        hide: function(opt, force) {
            ...
            //$(document).off('.contextMenu2AutoHide keydown.contextMenu2'); // http://bugs.jquery.com/ticket/10705
            $(document).off('.contextMenu2AutoHide').off('keydown.contextMenu2');
            // hide menu
        ...
        create: function(opt, root) {
                ...
                if (typeof item == "string") {
                    ...
                    switch (item.type) {
                        ...
                        case 'sub':
                            ...
                            op.create(item, root);
                            $t.data('contextMenu2', item).addClass('context-menu-submenu');
                            item.callback = null;
                            break;
            ...
            // attach contextMenu2 to <body> (to bypass any possible overflow:hidden issues on parents of the trigger element)
            if (!opt.$node) {
...
// handle contextMenu2 triggers
    $.fn.contextMenu2 = function(operation) {
        if (operation === undefined) {
            this.first().trigger('contextmenu');
        } else if (operation.x && operation.y) {
            this.first().trigger($.Event("contextmenu", {pageX: operation.x, pageY: operation.y}));
        } else if (operation === "hide") {
            var $menu = this.data('contextMenu2').$menu;
            $menu && $menu.trigger('contextmenu:hide');
        } else if (operation === "destroy") {
            $.contextMenu2("destroy", {context: this});
        } else if ($.isPlainObject(operation)) {
            operation.context = this;
            $.contextMenu2("create", operation);
        } else if (operation) {
...
// manage contextMenu2 instances
    $.contextMenu2 = function(operation, options) {
        ...
        switch (operation) {
            case 'create':
                ...
                if (!initialized) {
                    ...
                    $document
                            .on({
                                'contextmenu:hide.contextMenu2': handle.hideMenu,
                                'prevcommand.contextMenu2': handle.prevItem,
                                'nextcommand.contextMenu2': handle.nextItem,
                                'contextmenu.contextMenu2': handle.abortevent,
                                'mouseenter.contextMenu2': handle.menuMouseenter,
                                'mouseleave.contextMenu2': handle.menuMouseleave
                            }, '.context-menu-list')
                            .on('mouseup.contextMenu2', '.context-menu-input', handle.inputClick)
                            .on({
                                'mouseup.contextMenu2': handle.itemClick,
                                'contextmenu:focus.contextMenu2': handle.focusItem,
                                'contextmenu:blur.contextMenu2': handle.blurItem,
                                'contextmenu.contextMenu2': handle.abortevent,
                                'mouseenter.contextMenu2': handle.itemMouseenter,
                                'mouseleave.contextMenu2': handle.itemMouseleave
                            }, '.context-menu-item');
            ...
            case 'destroy':
                ...
                if (_hasContext) {
                    ...
                    $.each(menus, function(ns, o) {
                        ...
                        if ($visibleMenu.length && $visibleMenu.data().contextMenu2Root.$trigger.is($(o.context).find(o.selector))) {
                    ...
                    $document.off('.contextMenu2 .contextMenu2AutoHide');
                    $.each(menus, function(ns, o) {
                        $(o.context).off(o.ns);
                    });
                    ...
                    $visibleMenu = $('.context-menu-list').filter(':visible');
                    if ($visibleMenu.length && $visibleMenu.data().contextMenu2Root.$trigger.is(o.selector)) {
                        $visibleMenu.trigger('contextmenu:hide', {force: true});
                    }
            ...
            case 'html5':
                ...
                // initialize $.contextMenu2 for them
                if ((!$.support.htmlCommand && !$.support.htmlMenuitem) || (typeof options == "boolean" && options)) {
                    $('menu[type="context"]').each(function() {
                        if (this.id) {
                            $.contextMenu2({
                                selector: '[contextmenu=' + this.id + ']',
                                items: $.contextMenu2.fromMenu(this)
                            });
                        }
                    }).css('display', 'none');
                }
...
// import values into <input> commands
    $.contextMenu2.setInputValues = function(opt, data) {
        if (data === undefined) {
            data = {};
        }
...
// export values from <input> commands
    $.contextMenu2.getInputValues = function(opt, data) {
        if (data === undefined) {
            data = {};
        }
...
// convert <menu> to items object
    function menuChildren(items, $children, counter) {
        ...
        $children.each(function() {
             ...
             * Not being the sadistic kind, $.contextMenu2 only accepts:
             * <command>, <menuitem>, <hr>, <span>, <p> <input [text, radio, checkbox]>, <textarea>, <select> and of course <menu>.
             * Everything else will be imported as an html node, which is not interfaced with contextMenu2.
             */
...
// convert html5 menu
    $.contextMenu2.fromMenu = function(element) {
        var $this = $(element),
                items = {};
...
// make defaults accessible
    $.contextMenu2.defaults = defaults;
    $.contextMenu2.types = types;
// export internal functions - undocumented, for hacking only!
    $.contextMenu2.handle = handle;
    $.contextMenu2.op = op;
    $.contextMenu2.menus = menus;
